...
class GameSetClassicalGameTest {
    ...
    void incrementGameSetScore() {
        List<List<RelativeGameSetScore>> inputData = List.of(
                ...
                List.of(new RelativeGameSetScore(5, 0), new RelativeGameSetScore(6, 0, true)),
                ...
                List.of(new RelativeGameSetScore(5, 1), new RelativeGameSetScore(6, 1, true)),
                ...
                List.of(new RelativeGameSetScore(5, 2), new RelativeGameSetScore(6, 2, true)),
                ...
                List.of(new RelativeGameSetScore(5, 3), new RelativeGameSetScore(6, 3, true)),
                ...
                List.of(new RelativeGameSetScore(5, 4), new RelativeGameSetScore(6, 4, true)),
                ...
                List.of(new RelativeGameSetScore(6, 5), new RelativeGameSetScore(7, 5, true))
        );

        for(List<RelativeGameSetScore> inputRelativeGameSetScoreAndExpectedGameSetScore : inputData) {
